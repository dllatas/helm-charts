...
{{- $root := .root -}}
{{- if $root.Values.run.includeCommonLabelsInRuntimeObjects }}
...
{{- with $root.Values.run.runtimeLabels }}
{{ toYaml . }}
{{- end }}
{{- end -}}
